...
public final class RoutingAppender extends AbstractAppender {
   ...
   private RoutingAppender(
      ...
      final Script defaultRouteScript,
   ...
   public void start() {
      if (this.defaultRouteScript != null) {
         if (this.configuration == null) {
            ...
            ScriptBindings bindings = scriptManager.createBindings(this.defaultRouteScript);
   ...
   public boolean requiresLocation() {
      return this.requiresLocation != null ? this.requiresLocation : false;
   }
   ...
   public static class Builder<B extends RoutingAppender.Builder<B>>
      ...
      public RoutingAppender build() {
         ...
         if (this.defaultRouteScript != null) {
            ScriptManager scriptManager = this.getConfiguration().getScriptManager();
            if (scriptManager == null) {
               RoutingAppender.LOGGER.error("Script support is not enabled");
               return null;
            }

            if (!scriptManager.isScriptRef(this.defaultRouteScript) && !scriptManager.addScript(this.defaultRouteScript)) {
               return null;
            }
         }
      ...
      public B setDefaultRouteScript(final Script defaultRouteScript) {
         this.defaultRouteScript = defaultRouteScript;
         return this.asBuilder();
      }
      ...
      public B setPurgePolicy(final PurgePolicy purgePolicy) {
         this.purgePolicy = purgePolicy;
         return this.asBuilder();
      }

      public B setRequestLocation(final boolean requiresLocation) {
         this.requiresLocation = requiresLocation;
         return this.asBuilder();
      }
   }
