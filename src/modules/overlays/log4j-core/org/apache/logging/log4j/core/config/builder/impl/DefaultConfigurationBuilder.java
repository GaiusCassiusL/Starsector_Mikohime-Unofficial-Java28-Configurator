...
public class DefaultConfigurationBuilder<T extends BuiltConfiguration> implements ConfigurationBuilder<T> {
   ...
   public T build(final boolean initialize) {
      ...
      try {
         ...
         if (this.level != null) {
            configuration.getStatusConfiguration().setStatus(this.level);
         }

         if (this.verbosity != null) {
            configuration.getStatusConfiguration().setVerbosity(this.verbosity);
         }

         if (this.destination != null) {
            configuration.getStatusConfiguration().setDestination(this.destination);
         }
