...
public class LoggerContextAdmin extends NotificationBroadcasterSupport implements LoggerContextAdminMBean, PropertyChangeListener {
   ...
   public void setConfigLocationUri(final String configLocation) throws URISyntaxException, IOException {
      if (configLocation != null && !configLocation.isEmpty()) {
         ...
         Configuration config = ((ConfigurationFactory)this.loggerContext.getInjector().getInstance(ConfigurationFactory.KEY))
            .getConfiguration(this.loggerContext, configSource);
   ...
   public void setConfigText(final String configText, final String charsetName) {
      ...
      try {
         ...
         Configuration updated = ((ConfigurationFactory)this.loggerContext.getInjector().getInstance(ConfigurationFactory.KEY))
            .getConfiguration(this.loggerContext, source);
