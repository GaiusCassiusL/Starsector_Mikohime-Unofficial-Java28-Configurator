         ...
         CLMem __result = new CLMem(
            CL10.nclCreateImage2D(
               ...
               MemoryUtil.getAddress0Safe(host_ptr)
                  + (
                     host_ptr != null
                        ? BufferChecks.checkBuffer(host_ptr, CLChecks.calculateImage2DSize(host_ptr, formatBuffer, image_width, image_height, image_row_pitch))
                        : 0
                  ),
               MemoryUtil.getAddressSafe(errcode_ret),
               function_pointer
                  ...
                  + (
                     host_ptr != null
                        ? BufferChecks.checkBuffer(
                           host_ptr,
                           CLChecks.calculateImage3DSize(host_ptr, formatBuffer, image_width, image_height, image_depth, image_row_pitch, image_slice_pitch)
                        )
                        : 0
                  ),
               MemoryUtil.getAddressSafe(errcode_ret),
