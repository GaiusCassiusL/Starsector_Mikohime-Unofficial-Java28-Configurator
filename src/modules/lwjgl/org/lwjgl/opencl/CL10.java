...
public final class CL10 {
   ...
   public static CLMem clCreateImage2D(
      ...
      if (host_ptr != null) {
         BufferChecks.checkBuffer(host_ptr, CLChecks.calculateImage2DSize(host_ptr, image_format, image_width, image_height, image_row_pitch));
      }
   ...
   public static CLMem clCreateImage3D(
      ...
      if (host_ptr != null) {
         BufferChecks.checkBuffer(
            host_ptr, CLChecks.calculateImage3DSize(host_ptr, image_format, image_width, image_height, image_height, image_row_pitch, image_slice_pitch)
         );
      }
