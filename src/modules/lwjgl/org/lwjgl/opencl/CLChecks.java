...
final class CLChecks {
   ...
   static int calculateImage2DSize(Buffer host_ptr, ByteBuffer format, long w, long h, long row_pitch) {
      if (!LWJGLUtil.CHECKS) {
         return 0;
      }
   ...
   static int calculateImage3DSize(Buffer host_ptr, ByteBuffer format, long w, long h, long d, long row_pitch, long slice_pitch) {
      if (!LWJGLUtil.CHECKS) {
         return 0;
      }
