...
public final class NVPathRendering {
   ...
   public static void glPathCommandsNV(int path, ByteBuffer commands, FloatBuffer coords) {
      ...
      nglPathCommandsNV(path, commands.remaining(), MemoryUtil.getAddress(commands), coords.remaining(), 5126, MemoryUtil.getAddress(coords), function_pointer);
   }

   public static void glPathCommandsNV(int path, ByteBuffer commands, boolean unsigned, ByteBuffer coords) {
      ContextCapabilities caps = GLContext.getCapabilities();
      long function_pointer = caps.glPathCommandsNV;
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(commands);
   ...
   public static void glPathCommandsNV(int path, ByteBuffer commands, boolean unsigned, ShortBuffer coords) {
      ContextCapabilities caps = GLContext.getCapabilities();
      long function_pointer = caps.glPathCommandsNV;
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(commands);
   ...
   public static void glPathCoordsNV(int path, FloatBuffer coords) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(coords);
      nglPathCoordsNV(path, coords.remaining(), 5126, MemoryUtil.getAddress(coords), function_pointer);
   }

   public static void glPathCoordsNV(int path, boolean unsigned, ByteBuffer coords) {
      ContextCapabilities caps = GLContext.getCapabilities();
      long function_pointer = caps.glPathCoordsNV;
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(coords);
      nglPathCoordsNV(path, coords.remaining(), unsigned ? 5121 : 5120, MemoryUtil.getAddress(coords), function_pointer);
   }

   public static void glPathCoordsNV(int path, boolean unsigned, ShortBuffer coords) {
      ContextCapabilities caps = GLContext.getCapabilities();
      long function_pointer = caps.glPathCoordsNV;
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(coords);
      nglPathCoordsNV(path, coords.remaining(), unsigned ? 5123 : 5122, MemoryUtil.getAddress(coords), function_pointer);
   }
   ...
   public static void glPathSubCommandsNV(int path, int commandStart, int commandsToDelete, ByteBuffer commands, boolean unsigned, ByteBuffer coords) {
      ContextCapabilities caps = GLContext.getCapabilities();
      long function_pointer = caps.glPathSubCommandsNV;
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(commands);
   ...
   public static void glPathSubCommandsNV(int path, int commandStart, int commandsToDelete, ByteBuffer commands, boolean unsigned, ShortBuffer coords) {
      ContextCapabilities caps = GLContext.getCapabilities();
      long function_pointer = caps.glPathSubCommandsNV;
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(commands);
   ...
   public static void glPathSubCoordsNV(int path, int coordStart, FloatBuffer coords) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(coords);
      nglPathSubCoordsNV(path, coordStart, coords.remaining(), 5126, MemoryUtil.getAddress(coords), function_pointer);
   }

   public static void glPathSubCoordsNV(int path, int coordStart, boolean unsigned, ByteBuffer coords) {
      ContextCapabilities caps = GLContext.getCapabilities();
      long function_pointer = caps.glPathSubCoordsNV;
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(coords);
      nglPathSubCoordsNV(path, coordStart, coords.remaining(), unsigned ? 5121 : 5120, MemoryUtil.getAddress(coords), function_pointer);
   }

   public static void glPathSubCoordsNV(int path, int coordStart, boolean unsigned, ShortBuffer coords) {
      ContextCapabilities caps = GLContext.getCapabilities();
      long function_pointer = caps.glPathSubCoordsNV;
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(coords);
      nglPathSubCoordsNV(path, coordStart, coords.remaining(), unsigned ? 5123 : 5122, MemoryUtil.getAddress(coords), function_pointer);
   }
   ...
   public static void glStencilFillPathInstancedNV(
      ...
      BufferChecks.checkDirect(paths);
      if (transformValues != null) {
         BufferChecks.checkBuffer(transformValues, numPaths * GLChecks.calculateTransformPathValues(transformType));
      }
   ...
   public static void glPathColorGenNV(int color, int genMode, int colorFormat, FloatBuffer coeffs) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      if (coeffs != null) {
         BufferChecks.checkBuffer(coeffs, GLChecks.calculatePathColorGenModeElements(genMode) * GLChecks.calculatePathColorGenFormatComponents(colorFormat));
      }
   ...
   public static void glPathTexGenNV(int texCoordSet, int genMode, int components, FloatBuffer coeffs) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      if (coeffs != null) {
         BufferChecks.checkBuffer(coeffs, GLChecks.calculatePathColorGenModeElements(genMode) * components);
      }

      nglPathTexGenNV(texCoordSet, genMode, components, MemoryUtil.getAddressSafe(coeffs), function_pointer);
   }
   ...
   public static void glCoverFillPathInstancedNV(
      ...
      nglCoverFillPathInstancedNV(
         numPaths, pathNameType, MemoryUtil.getAddress(paths), pathBase, coverMode, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer
      );
   }
   ...
   public static void glGetPathMetricsNV(int metricQueryMask, int pathNameType, ByteBuffer paths, int pathBase, int stride, FloatBuffer metrics) {
      ...
      int numPaths = paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType);
      BufferChecks.checkDirect(paths);
      BufferChecks.checkBuffer(metrics, numPaths * GLChecks.calculateMetricsSize(metricQueryMask, stride));
      nglGetPathMetricsNV(
         metricQueryMask, numPaths, pathNameType, MemoryUtil.getAddress(paths), pathBase, stride, MemoryUtil.getAddress(metrics), function_pointer
      );
   }
