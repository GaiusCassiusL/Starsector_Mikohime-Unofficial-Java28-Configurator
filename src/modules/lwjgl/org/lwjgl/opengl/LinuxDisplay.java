...
final class LinuxDisplay implements DisplayImplementation {
   ...
   private static ByteBuffer getCurrentGammaRamp() throws LWJGLException {
      ...
      try {
         ...
         try {
            return isXF86VidModeSupported() ? nGetCurrentGammaRamp(getDisplay(), getDefaultScreen()) : null;
         } finally {
            decDisplay();
         }
      } finally {
   ...
   public DisplayMode[] getAvailableDisplayModes() throws LWJGLException {
      ...
      try {
         ...
         if (this.current_displaymode_extension != 10) {
            ...
            XRandR.Screen[] resolutions = XRandR.getResolutions(XRandR.getPrimaryScreenName());
