...
final class LWJGLMouse extends Mouse {
   ...
   private static Component[] createComponents() {
      return new Component[]{
         new LWJGLMouse.Axis(net.java.games.input.Component.Identifier.Axis.X),
         new LWJGLMouse.Axis(net.java.games.input.Component.Identifier.Axis.Y),
         new LWJGLMouse.Axis(net.java.games.input.Component.Identifier.Axis.Z),
         new LWJGLMouse.Button(net.java.games.input.Component.Identifier.Button.LEFT),
         new LWJGLMouse.Button(net.java.games.input.Component.Identifier.Button.MIDDLE),
         new LWJGLMouse.Button(net.java.games.input.Component.Identifier.Button.RIGHT)
      };
   }
   ...
   static final class Axis extends AbstractComponent {
      Axis(net.java.games.input.Component.Identifier.Axis axis_id) {
   ...
   static final class Button extends AbstractComponent {
      ...
      Button(net.java.games.input.Component.Identifier.Button button_id) {
