...
public class Plugins {
   ...
   public Class[] get() {
      ...
      // decompiler artifact: raw List.toArray() returns Object[]; cast to expected return type
   ...
   public Class[] getImplementsAny(Class[] interfaces) {
      ...
      // decompiler artifact: raw List enhanced-for gives Object; cast to expected element type
      for (Class pluginClass : (java.util.List<Class>) this.pluginList) {
